...
/**
 * AppUserParam entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "app_user_param", catalog = "ebs")
public class AppUserParam extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public AppUserParam(String id) {
		this.id = id;
	}

	/** full constructor */
	public AppUserParam(String id, String sysUserId, String sysUserName,
			String paramCategory, String paramName, String paramValue,
			Short sequence, String createdDate, String createdBy,
