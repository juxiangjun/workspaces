...
/**
 * OrgCompanyModel entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "org_company_model", catalog = "ebs")
public class OrgCompanyModel extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public OrgCompanyModel(String id) {
		this.id = id;
	}

	/** full constructor */
	public OrgCompanyModel(String id, String modelId, String companyId,
			String type, String startDate, String endDate, String createdDate,
