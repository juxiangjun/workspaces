...
public class SysView extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public SysView(String id, String viewCode, String viewName,
			String viewComment, String viewScript, String sysObjectId,
			String sysObjectCode, String sysObjectShortName, Short isDefault,
			String ownerId, String ownerCode, String ownerFullName,
			String combineType, Short limited, Short shared, String hql,
			Short position, String createdDate, String createdBy,
