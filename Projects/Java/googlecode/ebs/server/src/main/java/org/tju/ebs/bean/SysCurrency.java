...
/**
 * SysCurrency entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sys_currency", catalog = "ebs")
public class SysCurrency extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public SysCurrency(String id, String countryId) {
		this.id = id;
		this.countryId = countryId;
	}

	/** full constructor */
	public SysCurrency(String id, String code, String name, String countryId,
