 ...
 */
@Entity
@Table(name = "org_department", catalog = "ebs")
public class OrgDepartment extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public OrgDepartment(String id, String code, String name,
			String orgCompanyId, String orgCompanyName,
			String departmentFunctionId, String departmentFunctionName,
			String startDate, String endDate, String comments, String parentId,
			String parentCode, String parentName, String location,
			String leaderName, Short isLeaf, String createdDate,
	...
	@Column(name = "department_function_id", length = 50)
	public String getDepartmentFunctionId() {
		return this.departmentFunctionId;
	}
	...
	@Column(name = "department_function_name", length = 50)
	public String getDepartmentFunctionName() {
		return this.departmentFunctionName;
	}
