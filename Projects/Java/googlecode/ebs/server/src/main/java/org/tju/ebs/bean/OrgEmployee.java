...
public class OrgEmployee extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public OrgEmployee(String id, String code, String personId,
			String fullName, String email, String jobTitle, String grade,
			String hireDate, String resignationDate, String orgCompanyId,
			String orgCompanyName, String status, String createdDate,
