...
public class ProdCategory extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public ProdCategory(String id, String code, String name, String fullName,
			Short isUsingFlag, String parentId, String parentName,
			String companyId, String isLeaf, String createdDate,
