...
/**
 * SysGroupMenu entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sys_group_menu", catalog = "ebs")
public class SysGroupMenu extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public SysGroupMenu(String id) {
		this.id = id;
	}

	/** full constructor */
	public SysGroupMenu(String id, String sysMenuId, String sysMenuCode,
			String sysMenuLabel, String sysGroupId, String sysGroupName,
		...
		this.sysMenuLabel = sysMenuLabel;
	...
	@Column(name = "sys_menu_id", length = 36)
	...
	@Column(name = "sys_menu_code", length = 50)
	...
	@Column(name = "sys_menu_label", length = 100)
	public String getSysMenuLabel() {
		return this.sysMenuLabel;
	}

	public void setSysMenuLabel(String sysMenuLabel) {
		this.sysMenuLabel = sysMenuLabel;
	}

	@Column(name = "sys_group_id", length = 36)
	...
	@Column(name = "sys_group_name", length = 100)
