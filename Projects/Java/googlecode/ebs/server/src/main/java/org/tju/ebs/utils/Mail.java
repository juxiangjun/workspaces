...
public class Mail {
	...
	private final String mailProperties = "/com/bz/ebs/configuration/resources/mail.properties";

	/*
	 * all parameters value were from mail.properties.
	 */
	...
	private void initialize() {
		Properties p = getProperties(mailProperties);
		this.smtpServer = p.getProperty("smtp_server");
		this.username = p.getProperty("user_name");
		this.password = p.getProperty("password");
		this.from = p.getProperty("from");
		this.displayName = p.getProperty("display_name");
		this.subject = p.getProperty("subject");
		this.content = p.getProperty("content");
		MessageFormat str = new MessageFormat(this.content);
		String[] replaced = new String[] { title, this.to, temporaryPassword };
