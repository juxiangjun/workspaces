...
$(document).ready(function(){
	...
	<s:if test="nb==1">
	    ...
	    $("#bizCity").html($("#province").find("option:selected").text()+$("#city").find("option:selected").text()+$("#district").find("option:selected").text());
    ...
    <form id="serForm" class="box_form" action="/user/Profile!update.act" method="post">
      <dl>
        ...
        <dd>
          ...
          <s:select id="orgtype11" name="usrServiceorg.orgtypeid" list="dataMap['companyType']" listKey="id" listValue="name"></s:select>
        </dd>
        <dd>
          <h6>企业联系地址：</h6>
          <label id="bizCity"></label>
        ...
        <dd>
          <h6>服务介绍：</h6>
          <textarea id="remarks" rows=5 cols=60 name="usrServiceorg.remarks">${ usrServiceorg.remarks}</textarea>
        </dd>
      </dl>
      <div class="hr_10"> &nbsp; </div>
      <div class="hr_10"> &nbsp; </div>
