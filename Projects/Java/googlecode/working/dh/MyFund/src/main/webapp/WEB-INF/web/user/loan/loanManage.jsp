  ...
  <div class="M_menu" style="margin-top: 20px; height: 220px;">
	<table style="margin-top: 20px;">
		<tr>
			...
			<td style="padding:5px;"><s:textfield name="loan.applyNum"/></td>
			<td  align="right">需求方名称:</td>
			<td  style="padding:5px;"><s:textfield name="loan.busiName"/></td>
		</tr>
		<tr>
			<td  align="right">贷款用途:</td>
			<td  style="padding:5px;"><s:select  headerKey="" headerValue="--请选择类型--" name="loan.loanPurpose" list="dataMap['loanpurpose']"  listKey="id" listValue="name" ></s:select></td>
			<td  align="right">贷款类型:</td>
			<td  style="padding:5px;"><s:select headerKey="" headerValue="--请选择类型--" name="loan.companyType" list="dataMap['loantype']" listKey="id" listValue="name" ></s:select></td>
		</tr>
		<tr>
			<td  align="right">发布时间:</td>
			<td  style="padding:5px;"><s:textfield name="createdtFirst" id="timeOne" readonly="readonly"/>~<s:textfield name="createdtSecond" id="timeTwo" readonly="readonly"/></td>
			<td  align="right">需求金额:</td>
			<td  style="padding:5px;"><s:textfield name="loanAmountOne"/>~<s:textfield name="loanAmountTwo"/></td>
		</tr>
		<tr>
			<td  align="right">贷款期限:</td>
			<td colspan="3" style="padding:5px;"><s:textfield name="loanMonthOne"/>~<s:textfield name="loanMonthTwo"/></td>
		</tr>
		<tr>
			<td colspan="2" align="right"><s:submit value="筛选"/> </td>
			<td colspan="2"  style="padding:5px;" ><input type="button" onclick="doQuery()" value="查看全部"/> </td>
