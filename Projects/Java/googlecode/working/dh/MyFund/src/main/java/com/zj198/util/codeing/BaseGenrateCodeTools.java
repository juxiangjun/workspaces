...
public class BaseGenrateCodeTools {
	public static void main(String[] args)  throws Exception {
		...
		tables.add("OrdFinanceProduct");//ORD_BUSILOANREQUEST
		tables.add("OrdDatafileList");
		tables.add("OrdFinanceArea");
		tables.add("OrdFinanceDatafile");
		tables.add("OrdFinanceInducty");
