...
<!--头部结束-->
  ...
  <div class="M_out">
  	<div class="M_out_L">
        ...
        <div align="center">
        	<p></p>
        	<s:if test="#session._user.type<5 or #session._user.type>12">
        		<s:if test="#session._user.id != sinItem.companyId">
        			<input id="btnApply" type="button" onclick="javascript:apply(${sinItem.id})" value="立即申请"/>
        		</s:if>
        	</s:if>
        </div>
        <!--表格部分结束-->
