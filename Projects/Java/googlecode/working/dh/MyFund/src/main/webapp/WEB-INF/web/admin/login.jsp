			...
			<div class="block small center login">
				...
				<div class="block_content">
					...
					<form action="/admin/Account!login.act" method="post">
						<p><label>用户名:</label> <input type="text" class="text" name="username" value="admin"/>
						</p>
						<p><label>密 码:</label> <input type="password" class="text" name="password" value="111111"/>
						</p>
						<p><label>验证码:</label><br/><input type="text" class="text" style="width:240px; margin-bottom:30px; overflow:hidden;" name="verifycode"/> <img src="/Captcha.act" onclick="this.src='/Captcha.act?d='+Math.random();"/>
						</p>
