...
/**
 * AppParam entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "app_param", catalog = "ebs")
public class AppParam extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public AppParam(String id, String paramCategory, String paramName,
			String paramValue, Short sequence, Short status,
