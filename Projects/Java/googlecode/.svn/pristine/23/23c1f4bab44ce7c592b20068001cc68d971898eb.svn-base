...
/**
 * OrgOccupation entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "org_occupation", catalog = "ebs")
public class OrgOccupation extends org.tju.ebs.bean.BaseEntity implements
	...
	/** default constructor */
	public OrgOccupation() {
	}

	/** minimal constructor */
	public OrgOccupation(String id) {
		this.id = id;
	}

	/** full constructor */
	public OrgOccupation(String id, String code, String name,
			String orgCompanyId, String orgCompanyName, String status,
			String startDate, String endDate, String createdDate,
