...
public class SysParam extends org.tju.ebs.bean.BaseEntity implements
	...
	/** full constructor */
	public SysParam(String listName, String listKey, String listLabelEn,
			String listLabelChn, String listLabel, Short sequence,
			Short status, String createdDate, String createdBy,
	...
	@Column(name = "list_label_en", length = 36)
	...
	@Column(name = "list_label_chn", length = 36)
	...
	@Column(name = "list_label", length = 100)
