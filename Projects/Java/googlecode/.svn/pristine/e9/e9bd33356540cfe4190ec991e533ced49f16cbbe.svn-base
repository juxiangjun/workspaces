...
<s:form action="/loanadmin/financeProduct!savefin.act" id="loanForm"  cssClass="box_form" style="margin:0px;" >
	<div class="C_title">产品参数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">${msg }</span></div>
	<div class="C_form">
            <dl>
              <dd>
                <h6>贷款产品名称：</h6>
                <s:textfield name="product.financeName" cssClass="input-text required number"  id="product_financeName"></s:textfield>
              </dd>
              <dd>
                <h6>贷款类型：</h6>
                <common:select name="product.financeType" cssClass="input-text" id="product_financeType" valueSetId="32" onchange="finance_type_chenge();"/>
              </dd>
              <dd>
                <h6>贷款期限：</h6>
                <s:textfield name="product.financeLittledt" cssClass="input-text required digits" id="product_financeLittledt"></s:textfield>~
                <s:textfield name="product.financeMostdt" cssClass="input-text required digits" id="product_financeMostdt"></s:textfield> &nbsp;&nbsp;月
                <label for="product_financeLittledt" class="error" generated="true" style="display:none;"></label>
				</dd>
				<dd>
                <h6>贷款金额：</h6>
                <s:textfield name="product.financeLittleamount" cssClass="input-text required number"></s:textfield>~
                <s:textfield name="product.financeBigamount" cssClass="input-text required number"></s:textfield> &nbsp;&nbsp;万
              ...
              <dd class="finance_type_154" style="display:none;" >
				...
				<dd>
                <h6>贷款利率：</h6>
				  <common:radio name="product.interestType"  valueSetId="33"/>
				</dd>
				<dd>
					<div><!--利率浮动范围 --></div>
				</dd>
                ...
                <h6>支持还款方式：</h6>
				  <common:checkbox name="financeProductSpModel.repaymentType" valueSetId="34"/>
				</dd>
				<dd class="finance_type_151 finance_type_152 finance_type_153">
                <h6>抵押类型：</h6>
				  <common:checkbox name="financeProductSpModel.mortgage" valueSetId="35"/>
				</dd>
				<dd class="finance_type_151">
                <h6>支持用途：</h6>
				  <common:checkbox name="financeProductSpModel.purposeCompany" valueSetId="14"/>
				</dd>
				<dd class="finance_type_152" style="display:none;">
                <h6>支持用途：</h6>
				  <common:checkbox name="financeProductSpModel.purposePersonRunning" valueSetId="17"/>
				</dd>
				<dd class="finance_type_153" style="display:none;">
                <h6>支持用途：</h6>
				  <common:checkbox name="financeProductSpModel.purposePersonBuy" valueSetId="23"/>
				</dd>
				...
				<dd class="finance_type_154" style="display:none;" >
                <h6>支持还款方式：</h6>
                <common:checkbox name="financeProductSpModel.repaymentTypeHouse" valueSetId="26"></common:checkbox>
              </dd>
              
				<dd>
                <h6>审批时间：</h6>
                <s:textfield name="product.checkTime" cssClass="input-text required digits"  id="product_checkTime"></s:textfield>&nbsp;天内
              </dd>
              <dd>
                <h6>面向区域：</h6>
	...
	<div class="C_form">
		<dl>
           <dd>
			...
			<dd>
                <h6>贷款产品介绍：</h6>
                <s:textarea name="product.proIntroduce" cols="35" rows="5"></s:textarea>
              </dd>
		</dl>
	</div>
	...
	<div class="C_form">
		<dl>
              ...
              <dd class="finance_type_151 finance_type_152">
                <h6>企业的总资产：</h6>
                <s:textfield name="financeProductSpModel.financeExtend.companyAllAsset" cssClass="input-text number" ></s:textfield>&nbsp;&nbsp;万元
              </dd>
              <dd class="finance_type_151">
                <h6>企业的年营业收入：</h6>
              ...
              <dd class="finance_type_152" style="display:none;" >
                <h6>保证金：</h6>
                <common:radio name="financeProductSpModel.financeExtend.needEnsure" valueSetMap="ZJ101"></common:radio>
              </dd>
              <dd class="finance_type_152" style="display:none;" >
                <h6>申请人行业经验：</h6>
              ...
              <dd>
                <h6>其他申请条件：</h6>
                <s:textarea name="product.otherRequire" cols="35" rows="5"></s:textarea>
              </dd>
		</dl>
		<div class="hr_10"> &nbsp; </div>
			<div class="center" style="width:200px;">
			<s:submit value="同意以下协议并发布贷款产品"  cssClass="but_gray" style="width:200px;"></s:submit>
			</div>
			<div class="hr_10"> &nbsp; </div>
	</div>
