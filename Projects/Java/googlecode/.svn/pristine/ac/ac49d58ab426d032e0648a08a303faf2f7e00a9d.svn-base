...
<s:form action="/loan/LoanRequest!loanSecond.act" id="loanForm" style="width:950px;" cssClass="box_form" >
...
<s:hidden name="loan.applyType" value="138"></s:hidden>
	...
	<div class="C_form">
            <dl>
              <dd>
                ...
                <h6>贷款金额：</h6>
                <s:textfield name="loan.loanAmount" cssClass="input-text required" ></s:textfield>&nbsp;&nbsp;万元
                <label for="loan.loanAmount" class="error" generated="true" style="display:none;"></label>
              </dd>
              <dd>
                <h6>贷款期限：</h6>
                <s:textfield name="loan.loanMonth" cssClass="input-text required" ></s:textfield>&nbsp;月
	...
	<div class="C_form">
		<dl>
			...
			<dd>
				<h6>行业经验：</h6>
				<s:textfield name="loan.experience" cssClass="input-text required" ></s:textfield>&nbsp;&nbsp;年
