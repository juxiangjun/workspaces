 ...
 */
@Entity
@Table(name = "sys_province", catalog = "ebs")
public class SysProvince extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public SysProvince(String id, String code, String shortName) {
		this.id = id;
		this.code = code;
	...
	/** full constructor */
	public SysProvince(String id, String code, String shortName,
			String fullName, String countryId, String countryCode,
			String countryShortName, String labelCode, String createdDate,
	...
	@Column(name = "country_short_name", length = 8)
	...
	@Column(name = "label_code", length = 8)
