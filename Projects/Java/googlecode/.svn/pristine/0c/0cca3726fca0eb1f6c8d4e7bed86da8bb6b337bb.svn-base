        ...
        <div class="on" id="login-cont0">
          <form id="loginform" class="box_form" action="/Account!login.act" method="post">
            <dl>
              ...
              <dd><h6>密码：</h6><input id="pass" name="password" type=password value="" class="input-text" /></dd>
        ...
        <div class="off" id="login-cont1">
          <form class="box_form" action="/Account!login.act" method="post">
            <dl>
              ...
              <dd><h6>证书密码：</h6><input id="pass2" name="password" type=password value="" class="input-text" /></dd>
              <dd><h6>&nbsp;</h6><input id=u4 type="button" onfocus=this.blur() onclick="this.form.submit()" class="but_gray" style="width:90px;" value="登录" /><span class="txt_info red"><a href="/Recovery.act">忘记密码？</a></span></dd>
              <dd><h6>&nbsp;</h6>如果您尚未注册，立即<a class="red" href="/Register.act">免费注册</a></dd>
            </dl>
          </form>
        </div>
