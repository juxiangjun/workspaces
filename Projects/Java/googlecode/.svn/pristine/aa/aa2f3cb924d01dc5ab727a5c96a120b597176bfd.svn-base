...
/**
 * OrgBank entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "org_bank", catalog = "ebs")
public class OrgBank extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public OrgBank(String id, Timestamp bankDate) {
		this.id = id;
		this.bankDate = bankDate;
	}

	/** full constructor */
	public OrgBank(String id, String orgCompanyId, String orgCompanyCode,
			String orgCompanyName, String principal, String bankName,
			String bankCode, String bankAccount, Timestamp bankDate,
	...
	@Column(name = "org_company_code", length = 100)
