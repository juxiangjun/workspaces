...
/**
 * SysModel entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sys_model", catalog = "ebs")
public class SysModel extends org.tju.ebs.bean.BaseEntity implements
	...
	/** minimal constructor */
	public SysModel(String id, String code) {
		this.id = id;
		this.code = code;
	}

	/** full constructor */
	public SysModel(String id, String code, String modelName, Double listPrice,
	...
	@Column(name = "list_price", precision = 18, scale = 4)
