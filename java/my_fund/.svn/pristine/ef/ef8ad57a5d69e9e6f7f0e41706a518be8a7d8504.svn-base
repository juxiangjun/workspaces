...
public class Constants{
	...
	public static final String FILE_NAME_ZJ198_FINANCE_AGREE = "\\upload\\zj198_finance_agree.pdf";
	...
	//管理员模拟用户登录
	public static final Integer ADMIN_IMITATE_USER_SOURCE = 2;
	...
	//用户付费状态
	public static final int USER_VIPTYPE_NONE = 0;		//资金网会员
	...
	public static final int USER_VIPTYPE_PAYSTATUS_OFF = 0;		//付款状态——未付款
	public static final int USER_VIPTYPE_PAYSTATUS_ON = 1;		//付款状态——已付款
...
//	public static final int BASEDATA_GROUP_MORTGAGE = 15;					//抵押物
	 ...
	 * 快速申请类型
	 */
	public static final Integer ORD_LOAN_TYPE_COMPANY = 136;
	public static final Integer ORD_LOAN_TYPE_PERSON = 138;
	 ...
	 * 审核内容类型(84)
	 */
	public static final Integer ORD_CHECK_CONTENT_COMPANY = 331;
	public static final Integer ORD_CHECK_CONTENT_COMPANY_APPLY = 332;
	public static final Integer ORD_CHECK_CONTENT_PERSON = 333;
	public static final Integer ORD_CHECK_CONTENT_PERSON_APPLY = 334;
	
	/**
	 * 融资意向单状态
	 */
	public static final Integer ORD_LOAN_ST_ZJWAIT = 143;
	public static final Integer ORD_LOAN_ST_ORGWAIT = 144;
	public static final Integer ORD_LOAN_ST_CHECK = 145;
	public static final Integer ORD_LOAN_ST_FAILURE = 146;
	/**
	 * 推荐产品类型
	 */
	 ...
	 * 推荐产品类型
	 */
	public static final Integer ORD_LOAN_RECOMMEND_TYPE_ZJ = 0;//资金网
	public static final Integer ORD_LOAN_RECOMMEND_TYPE_BANK = 1;//金融机构
	
	/**
	 * 资料模版类型
	 */
	public static final Integer TEMPLATE_TYPE_PRD = 0;//产品资料模版
	public static final Integer TEMPLATE_TYPE_ORD = 1;//补充资料模版
	
	/**
	 * 合作伙伴
	 */
	public static String PNR_COOKIE_REFERENCE_NAME = "PNR_REFERENCE_ID";//存入到cookie中合作伙伴ID的名称
	public static String PNR_URL_PARAM_NAME = "referenceId";//合作伙伴连接所携带的参数名
	...
	public static final String JSNAME = "base-rate.js";
