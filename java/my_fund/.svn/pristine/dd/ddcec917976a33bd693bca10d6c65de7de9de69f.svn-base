...
$(function(){
	$("#frmProjectInvest").validate({
		messages:{
			...
			'clbSupplyInfo.workRange'		: '<li>证券直投不能留空</li>',
...
<div class="box_3">
	...
	<form action="/service/supplyInfoAction4User!save.act" id="frmProjectInvest" method="post">
		...
		<table class="form_table">
			...
			<tr>
				<td width="１8%" class="form_table field_name">标题：</td>
			...
			<tr>
				<td class="form_table field_name">证券直投：</td>
				<td>
					<s:radio list="#{'IPO':'IPO','自营业务':'自营业务','私募':'私募','信托':'信托','基金':'基金' }" cssClass="required" name="clbSupplyInfo.workRange" ></s:radio>
				</td>
			</tr>
			<tr>
