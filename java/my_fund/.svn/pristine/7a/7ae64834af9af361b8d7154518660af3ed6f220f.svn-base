...
public class UsrMemberPeroidDAOImpl extends HibernateDAO<UsrMemberPeroid, Integer> implements UsrMemberPeroidDAO {
	...
	public Pager findAllUsrMP(String ordNum,String username,Integer status,Integer memberType,Date[] startdt,Date[] createdt,Integer pageNo, Integer pageSize) {
		String hql = "select new com.zj198.model.UsrMemberPeroid(u.userId,u.memberStart,u.memberEnd,u.memberType,u.createTime,u.orderId,u.status,user.username,o.ordNum) from UsrMemberPeroid as u ,UsrUser as user,OrdMembership as o where u.userId=user.id and u.orderId=o.id";
	...
	public UsrMemberPeroid getUsrMP(Integer userid) {
		String hql="from UsrMemberPeroid as model where model.userId=:userId and model.status != 2 order by model.createTime desc";
	...
	public List<UsrMemberPeroid> findUsrMP(Integer userid) {
		String hql="from UsrMemberPeroid as model where model.userId=:userId and model.status != 2";
