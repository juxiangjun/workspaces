...
//	}
	...
	public  List<UsrBank>  getUsrBanks(String name){
		return this.usrBankDAO.findUsrBanksByName(name);
	}
	public List<UsrFinanceorg>  getFinanceOrgs(String name, Integer[] types) {
		return this.usrFinanceorgDAO.findUsrFinanceOrgs(name, types);
	}
