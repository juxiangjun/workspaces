	            ...
	            <dl>
	              ...
	              <dd>
	                ...
	                <h6 style="width:280px"><span class="txt-impt">*</span>是否有抵押物：</h6>
					  <input id="radio1" type="radio" onclick="validateShow()" name="apply.haveMortgage" value="1" class="required" checked="checked"/><label for="radio1">能提供</label>
		...
		<div class="C_form">
			<dl>
				<s:iterator value="extendsPropertyList" id="epid">
					<dd>
						<h6 style="width:280px"><span class="txt-impt">*</span>${fieldName }：</h6>
