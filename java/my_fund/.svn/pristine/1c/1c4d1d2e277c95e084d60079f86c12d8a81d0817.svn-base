    ...
    <form class="box_form">
      ...
      <s:if test="msg!=null">
        ...
        <tr>
          ...
          <s:if test="profileMap['business'] != ''">
	          <td class="a_right" title="${profileMap['business']}"><div class="ellipsis_text_100">${profileMap['business']}</div></td>
	          <td class="a_left"><a href="/user/orgAttach.act?attachId=${profileMap['businessId'] }">下载</a></td>
          </s:if><s:else>
          	<td colspan="2">&nbsp;</td>
          </s:else>
        </tr>
        <tr>
          ...
          <s:if test="profileMap['orgAnization'] != ''">
	          <td class="a_right" title="${profileMap['orgAnization'] }"><div class="ellipsis_text_100">${profileMap['orgAnization'] }</div></td>
	          <td class="a_left"><a href="/user/orgAttach.act?attachId=${profileMap['orgAnizationId'] }">下载</a></td>
          </s:if><s:else>
          	<td colspan="2">&nbsp;</td>
          </s:else>
        </tr>
        <tr>
          ...
          <s:if test="profileMap['taxregistration'] != ''">
	          <td class="a_right" title="${profileMap['taxregistration']}"><div class="ellipsis_text_100">${profileMap['taxregistration']}</div></td>
	          <td class="a_left"><a href="/user/orgAttach.act?attachId=${profileMap['taxregistration']}">下载</a></td>
          </s:if><s:else>
          	<td colspan="2">&nbsp;</td>
          </s:else>
        </tr>
