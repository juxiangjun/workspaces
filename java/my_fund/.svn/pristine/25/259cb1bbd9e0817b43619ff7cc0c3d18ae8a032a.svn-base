		...
		<div class="block">
			...
			<div class="block_content">
				...
				<table cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							<td>
								<label>付费订单号</label><input value="${ordNum }" type="text" name="ordNum" class="text" style="width: 100px;"/>
							</td>
							<td>
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="tablesorter">
					...
					<tbody>
						...
						<tr <s:if test="#i.even">class="even"</s:if><s:else>class="odd"</s:else>>
							...
							<s:elseif test="#u.status==1">使用中</s:elseif><s:elseif test="#u.status==2">已过期</s:elseif><s:else>没有状态</s:else>
							</td>
							<td colspan="2">
								未定
							</td>
