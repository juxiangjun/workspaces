...
public class UsrPerson implements java.io.Serializable {
	...
	public void setAuditFieldsLoan(UsrPerson up){
//		this.setBirthday(up.getBirthday());
		this.setEducation(up.getEducation());
		this.setCid(up.getCid());
		this.setProvinceid(up.getProvinceid());
		this.setCityid(up.getCityid());
		this.setDistrictid(up.getDistrictid());
		this.setCareerid(up.getCareerid());
	}
...
//	}
	public String validOthersFieldsLoan(UsrPerson usrPerson){
		String msg="1#";
