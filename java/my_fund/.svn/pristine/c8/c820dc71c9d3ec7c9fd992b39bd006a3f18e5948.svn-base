...
<table class="gold-table" border="0" cellspacing="0" cellpadding="0">
  <caption>
  <span class="fr view_all"><a href="/user/loan/LoanRequest.act?mparamid=12">查看全部»</a></span>
  <h6>融资意向</h6>
  <!-- 企业 -->
  ...
  <s:iterator value="topThree" id="item">
	  <tr>
		...
		<td>${loanMonth}月</td>
   		...
   		<a target="_blank" href="/user/loan/LoanRequest!loanManageDetail.act?loan.id=${id }" style="width:30px;">查看</a>
   		</td>
	  </tr>
  </s:iterator>
</table>