		...
		<div class="block">
			...
			<div class="block_content">
				...
				<form action="/admin/ads/post!add.act" method="post" id="addform">
					...
					<p>
						<label>开始日期：</label> <input name="adsPost.startdate" class="text date_picker" style="width:120px;"/>
					</p>
					<p>
						<label>结束日期：</label> <input name="adsPost.enddate" class="text date_picker" style="width:120px;"/>
					</p>
					<p>
						<label>状&nbsp;&nbsp;&nbsp;&nbsp;态：</label> <s:radio name="adsPost.status" cssClass="check_radio" list="#{'0':' 正常','1':' 停止'}" value="0"/>
					</p>
					<hr/>
					<p>
