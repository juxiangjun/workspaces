      ...
      <table border="0" cellpadding="0" cellspacing="0" class="psfs_tb">
       <s:if test="msg!=null">
        ...
        <tr>
          ...
          <td><div class="ellipsis_text_100" title="${profileMap['business']}"><label id="licensecodeMsg"><s:if test="profileMap['business'] != ''">${profileMap['business']}</s:if>&nbsp;</label></div></td>
        ...
        <tr>
          ...
          <td><div class="ellipsis_text_100" title="${profileMap['orgAnization'] }"><label id="organizationMsg"><s:if test="profileMap['orgAnization'] != ''">${profileMap['orgAnization'] }</s:if>&nbsp;</label></div></td>
        ...
        <tr>
          ...
          <td><div class="ellipsis_text_100" title="${profileMap['taxregistration']}"><label id="faxcodeMsg"><s:if test="profileMap['taxregistration'] != ''">${profileMap['taxregistration']}</s:if>&nbsp;</label></div></td>
        ...
        <tr>
          ...
          &nbsp;万元<br />
	          <label for="usrServiceorg.registeredcapital" class="error" generated="true" style="display:none;"></label> 
          </td></tr>
        <tr>
...
<div id="pop_userimg" style="display:none;" title="上传扫描件">
  <form id="imgform" action="/user/uploadOrg.act" method="post" enctype="multipart/form-data">
   <table id="t_border">
   	...
   	<tr><td><s:hidden id="orgType" name="orgType" value="0" /><s:file id="up_img" name="upload" value=""/><input type="button" onclick="uploadImg();" value="确认提交"/></td></tr>
   	<tr><td></td></tr>
