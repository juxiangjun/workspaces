...
public class UsrUser implements java.io.Serializable {
	...
	private Integer imitateUserAdminId;//非数据库映射对象
	...
	public UsrUser(Integer id, Short type,String username, String realname, String email, String mobile,Short gender,Short status,Short activetype, Short auditstatus,Integer userTypeGroup,String avatar,Integer viptype,Integer imitateUserAdminId) {
		super();
		this.id = id;
		this.type = type;
		...
		this.imitateUserAdminId=imitateUserAdminId;
	}
	...
	public Integer getImitateUserAdminId() {
		return imitateUserAdminId;
	}

	public void setImitateUserAdminId(Integer imitateUserAdminId) {
		this.imitateUserAdminId = imitateUserAdminId;
	}
