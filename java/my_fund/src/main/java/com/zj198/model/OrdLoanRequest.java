...
/**
 * OrdLoanRequest entity. @author MyEclipse Persistence Tools
 */

/**
 * @author zeroleavebaoyang@gmail.com
 * @since 2012-6-29|上午10:44:10
 */
public class OrdLoanRequest implements Serializable {

	private static final long serialVersionUID = 6765694491795364973L;
	...
	private Double lastyearDebt;
	private Double lastyearProfit;
    private Double lastyearVolume;
    ...
    private Integer userCreditCard;
    private Integer userId;
    private Integer workTime;
    private Integer toOrgStatus;
    private String toOrgMemo;

    /** default constructor */
	public OrdLoanRequest() {
	}
    ...
    public Double getLastyearDebt() {
        return this.lastyearDebt;
	}
    ...
    public Double getLastyearVolume() {
    ...
    public Integer getUserCreditCard() {
	...
	public void setLastyearDebt(Double lastyearDebt) {
    ...
    public void setLastyearVolume(Double lastyearVolume) {
    ...
    public void setUserCreditCard(Integer userCreditCard) {
	...
	public String getToOrgMemo() {
		return toOrgMemo;
	}

	public void setToOrgMemo(String toOrgMemo) {
		this.toOrgMemo = toOrgMemo;
	}
