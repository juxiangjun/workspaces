...
//	private Pagination pagination;
	...
	private List<FundCompany> compList;
	
	private List<PrdRecommendation> bankFinanceRecommendationList;
	private List<PrdRecommendation> bankRecommendationList;
	private List<PrdRecommendation> fundRecommendationList;
	...
	public String execute() throws Exception {
		...
		fundList();
		fundRecommendationList=this.financeProdService.findRecommendationByTopNumber(3, 3);
		bankRecommendationList=this.financeProdService.findRecommendationByTopNumber(1, 3);
		return SUCCESS;
	}
	/**融资餐饮基金页*/
	...
	private void fundList(){
		fundPager=fundService.findFundAll(null, null, null, null, null, pageSize, pageNo,"1",null);
		compList=this.fundService.findComAllIssue();
	}
	//-------------------end
...
//	}
	...
	public List<FundCompany> getCompList() {
		return compList;
	}
	public List<PrdRecommendation> getFundRecommendationList() {
		return fundRecommendationList;
	}
	public List<PrdRecommendation> getBankRecommendationList() {
		return bankRecommendationList;
	}
