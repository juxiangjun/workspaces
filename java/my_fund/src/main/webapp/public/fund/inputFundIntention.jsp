...
<!-- 企业经营贷款快速申请类型=136 -->
	...
	<div class="C_form">
            <dl>
              <dd>
                <h6>姓名：</h6>
                <s:textfield name="fundIntention.userName" cssClass="input-text required"  id="fundIntention.userName" value="%{#session._user.realname}"></s:textfield>
                &nbsp;&nbsp;<s:radio list="#{1:'先生' ,0:'女士'}" name="fundIntention.gender" value="%{#session._user.gender}"></s:radio>
              </dd>
              <dd>
                <h6>手机：</h6>
                <s:textfield name="fundIntention.mobile" cssClass="input-text required mobile"  id="fundIntention.mobile" value="%{#session._user.mobile}"></s:textfield>
              </dd>
              <dd>
                <h6>邮箱：</h6>
                <s:textfield name="fundIntention.email" cssClass="input-text required email"  id="fundIntention.email"  value="%{#session._user.email}"></s:textfield>
              </dd>
              <dd>
                <h6>期望服务时间：</h6>
