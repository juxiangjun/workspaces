        ...
        <div style="width:708px; height:auto;">
			<div class="box_5">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="map_connect">
				  ...
				  <tr>
				    <td><a href="http://www.chinaccm.com/" target="_blank"/><img src="/images/linkimg/chinaccm.png" /></a></td>				  
				    <td></td>
				    <td></td>
				    <td></td>
				    <td></td>
				...
				<table border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
				    <td class="map_title">我站链接信息：</td>
				  </tr>
				  <tr>
				    <td>1、链接文本：中国资金网</td>
				  </tr>
				  <tr>
				    <td>2、链接提示：中国领先的第三方金融服务电子平台</td>
				  </tr>
				  <tr>
				    <td>3、<a class="red" href="/images/zj198_linklogo.png">中国资金网Logo</a></td>
				  </tr>				  					  					  					  			  					  			  
				</table>																
			</div>
        </div>
