	...
	<div class="wrapper">
		...
		<div class="block">
			...
			<div class="block_content">
				...
				<form action="/admin/ads/item!add.act" method="post" id="addform" enctype="multipart/form-data">
					<p>
						<label>广告名称：</label> <s:textfield cssClass="text" name="adsItem.name" cssStyle="width:300px;"/> <span class="note">广告名称，45字以内含标点符号</span>
					</p>
					<p>
						<label>广告链接：</label> <s:textfield cssClass="text" name="adsItem.link"/> <span class="note">广告链接地址，内部以“/”开头，外部地址以“http://”开头，64字以内含符号</span>
					</p>
					<p>
