...
<script>
	function toPage(pageNo, pageCount) {
		$("#announcement").html("");
		$.post("/admin/fund/fund!fundAnnouncement.act",{pageNo:pageNo,fundId:'${fundId}'},function(data){
      ...
      <tr class="top_color">
		...
		<s:iterator value="pager.data">
	      <tr class="capital_table" >
	        ...
	        <td class="capital_table_0"><a target="_blank" href="/admin/fund/fund!editFundAnnouncement.act?detailId=${id }">修改</a></td>
	      </tr>
		</s:iterator>
		<tr>
