	...
	<div class="f_box">	
		...
		<table class="special_psfs_tb">
			...
			<tr>
				...
				<td ><s:if test="mType == 1"><span class="red" style="padding-right:40px;">365元</span><span><input type="radio" name="a" value="1" checked="checked"/>1年会员费</span>&nbsp;&nbsp;<!--  <input type="radio" name="b" value="2" />2年会员费&nbsp;&nbsp; <input type="radio" name="c" value="3" />3年会员费</span>-->
					</s:if><s:elseif test="mType == 2"><span class="red" style="padding-right:40px;">5000元</span><span><input type="radio" name="a" value="1" checked="checked"/>1年会员费</span>&nbsp;&nbsp; <!-- <input type="radio" name="b" value="2" />2年会员费&nbsp;&nbsp; <input type="radio" name="c" value="3" />3年会员费</span> --></s:elseif></td>
			</tr>
			</table>
			<div class="hr_20"> &nbsp;</div>			      			
		 </div>
