...
<script language="javascript">
    ...
    function downloadAttach(prdId){
    	var url = "/user/loan/prdAttach!getDataTemplates.act";
...
<div id="fileList">
   ...
   <div class="hr_10"> &nbsp;</div>
	<s:form id="uploadForm" action="prdAttach!uploadTemplate.act" namespace="/user/loan" method="post" enctype="multipart/form-data">
