...
$(function(){
	$("#frmLoanInfo").validate({
		messages:{
			...
			'clbSupplyInfo.companytype'		: '<li>借贷性质不能不选!</li>',
			'clbSupplyInfo.workTrade'		: '<li>您还没有选择行业!</li>',
			'clbSupplyInfo.workRange'		: '<li>借贷范围不能留空</li>',
...
<div class="box_3">
	...
	<div class="xxkbox2">
		<form action="/service/supplyInfoAction4User!save.act" id="frmLoanInfo" method="post">
		...
		<table class="form_table">
			...
			<tr>
				<td   class="form_table field_name">借贷性质：</td>
				<td>
					<s:radio list="#{'个人':'个人','企业':'企业','小额贷款公司':'小额贷款公司' }" name="clbSupplyInfo.companytype" cssClass="required"></s:radio>
				</td>
			</tr>
			<tr>
				<td  class="form_table field_name">借贷范围：</td>
				<td>
				</td>
			</tr>
			<s:iterator id="item" value="loanUsageList">
				<s:if test="#item.parentId==0">
					<tr> 
					<td class="form_table parameter_name">${item.name }</td><td>
						<s:iterator id="child" value="loanUsageList">
			...
			<tr>
				...
				<td><s:select list="timeIntervalList" listKey="code" cssClass="required" listValue="name" name="clbSupplyInfo.expiredDate" ></s:select></td>
			</tr>
			<tr>
