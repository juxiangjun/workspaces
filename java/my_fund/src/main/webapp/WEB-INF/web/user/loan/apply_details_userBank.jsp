...
<div class="container_950 box_4">
	...
	<div class="line" style="background:#f9f9f7;">
		<div class="f_text01" style="width: 895px;">
      ...
      <div class="f_box">
		...
		<div class="clear"> &nbsp;</div>      
      	...
      	<div class="f_sqxx">
			...
			<div>
				<div class="fl f_qyxx" style=":auto; padding: 5px 0;">
				    <div class="menu_out">
...
<div class="container_950 center box_6 hid">
		...
		<td align="right"><a href="javascript:void(0)" id="myhide" class="ico_name"><img src="/images/down_ico.png"/></a></td> 
     	...
     	<tr class="top_color">
     		<td width="32%" style="padding-left:25px;"><input type="checkbox" name="ckboxs" class="ckbox" id="selectall"/>&nbsp;资料名称</td>
            <td >递交方式</td>
            <td width="10%">状态</td>
...
<!--弹出框接收到申请页面-->
	<div id="step1" title="填写接收到申请意见：" style="display: none;">
		<form action="/user/loan/userApplyManag!updateAccept.act" id="checkForm1" class="box_form" style="margin:0px;" method="post">
			...
			<table class="center">
				<tr>
					<td style="vertical-align: top;">接收到申请意见：</td>
					<td><textarea rows="5" cols="60" class="required {maxlength:150}" name="checkViewInput" id="area1">资金方正在对您的融资申请进行审核，请随时关注进展状况，谢谢！
					</textarea>
					</td>
				</tr>
				<tr>
	...
	<div id="step2" title="填写退回修改材料意见：" style="display: none;">
		<form action="/user/loan/userApplyManag!updateMaterial.act" id="checkForm2" class="box_form" style="margin:0px;" method="post">
			...
			<table>
				...
				<tr>
					<td colspan="2" class="r_td" style="vertical-align: top;" align="center">
...
<!--弹出框资金方审核通过页面-->
	<div id="step3" title="填写资金方审核通过意见：" style="display: none;">
		<form action="/user/loan/userApplyManag!updateSucc.act" id="checkForm3" class="box_form" style="margin:0px;" method="post">
			...
			<table class="center">
				<tr>
					<td style="vertical-align: top;">资金方审核通过意见：</td>
					<td><textarea rows="5" cols="60" class="required {maxlength:150}" name="checkViewInput" id="area3">恭喜您，您的融资申请已通过资金方的审核，资金方将尽快放款，请注意查收！
					</textarea><br />
					</td>
				</tr>
				<tr>
