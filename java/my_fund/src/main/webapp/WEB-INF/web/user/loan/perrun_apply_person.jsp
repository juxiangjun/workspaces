		...
		<div class="C_title">个人信息&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:red;">${msg }</span></div>
			<div class="hr_10"> &nbsp; </div>
			 ...
			 <tr>
	           ...
	           <td><input name="usrPerson.realName" value="${session._user.realname}"/> </td>
	         </tr>
	         <tr>
	           <td class="a_right">性别:</td>
	           <td>
	           		<input type="radio" name="usrPerson.gender" value="1" <s:if test="#session._user.gender==1">checked="checked"</s:if> >先生</input>
	           		<input type="radio" name="usrPerson.gender" value="0" <s:if test="#session._user.gender!=1">checked="checked"</s:if> >女士</input>
	           </td>
	         </tr>
	         <!-- 
	         <tr>
	         ...
	         <tr>
	           ...
	           <td><input type=text value="${usrPerson.cid}" class="input-text required idcardno" name="usrPerson.cid"/></td>
	           <!-- <td>${usrPerson.cid}</td>-->
	         </tr>
	         <tr>
	         ...
	         <tr>
	           ...
	           <td><input type=text value="${usrPerson.address }" class="input-text required {maxlength:32}" style="width:534px;" name="usrPerson.address" /><span class="ask_text"></span></td>
	           <!-- 
	           <td>${usrPerson.address }</td>-->
	         </tr>              
	         <tr>
	           <td class="a_right" style="vertical-align:top;">邮政编码:</td>
	           <td><input type="text" value="${usrPerson.postcode }" name="usrPerson.postcode" id="textfield" class="input-text required zipCode"/><span class="ask_text"></span></td>
	           <!-- 
