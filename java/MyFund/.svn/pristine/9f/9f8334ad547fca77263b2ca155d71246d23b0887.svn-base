		    ...
		    <dl>
				...
				<dd>
				   	<h6><span class="txt-impt">*</span>服务标题：</h6>
				    	<s:textfield id="prdServiceItem.title" name="prdServiceItem.title" cssClass="required" maxlength="50" ></s:textfield>
				    </dd>
				<dd>
					<h6></h6>
			   ...
			   <dd>
				...
				<dd>
			    	<h6><span class="txt-impt">*</span>收费范围：</h6>
			     	<s:textfield id="prdServiceItem.chargeRange" name="prdServiceItem.chargeRange" cssClass="required" maxlength="50" ></s:textfield>
			    </dd>
				<dd>
					<h6></h6>
