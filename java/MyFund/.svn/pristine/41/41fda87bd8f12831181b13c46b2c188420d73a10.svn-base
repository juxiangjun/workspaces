...
<div class="center box_6_gray" style="width:942px; height:auto; padding:0px; border: #d6d6d6 solid 4px;">
	...
	<table border="0" cellspacing="0" cellpadding="0" class="qy_jians">
	  <tr>
	    ...
	    <td width="15%" align="right"  class="v-align"><a href="javascript:search();" class="btn bred">重新搜索</a></td>
	  </tr>
	  <tr>
	    <td width="60" align="right" class="v-align">金额：</td>
	    <td align="center" class="v-align"><input type=text name="financeAmount" id="amount" class="input-text defaultvalue" <s:if test="financeAmount==''||financeAmount==null">value="不限"</s:if><s:else>value="${financeAmount }"</s:else> style="width:120px;"/>&nbsp;万元<br/>
...
<table class="container_950 center box_4"> 
      <tr class="top_color">
        ...
        <td class="capital_table_a2" style="border-bottom:3px solid #97181d;">产品特点</td>
      ...
      <s:if test="#st.Even">
      	<tr style="background:#f9f9f7;" class="capital_table">
      </s:if>
      <s:else>
        ...
        <td class="capital_table_a3" style="border:0px;"><common:print valueId="repaymentType" divide="br"/></td>
       	<td class="capital_table_a2 red" style="border:0px;"><common:print valueId="proSpecial" divide="br"/></td>
        <td class="capital_table_a2" style="border:0px;">${checkTime}个工作日</td>
        <td style="padding-top:10px; border:0; width:80px;">
