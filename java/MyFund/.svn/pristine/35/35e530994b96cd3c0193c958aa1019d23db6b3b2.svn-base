...
function toPage(pageNum, pageSize){
	var url = "/admin/loan/loanRequest.act";
	...
	<div class="wrapper">
		<s:include value="/WEB-INF/web/admin/head.jsp"></s:include>
	 	<div class="block">
				...
				<!-- .block_head ends -->
				<form id="frmLoanManage" action="/admin/loan/loanRequest.act" method="post">
				...
				<div class="block_content">
					<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
						<tr>
							<td>
								<label>编号:</label><s:textfield name="spModel.requestNum" cssClass="text" style="width: 100px;"></s:textfield>
							</td>
							<td>
							...
							<td>
								<label>类别:</label><common:select name="spModel.financeType" valueSetId="27" headerKey="-1" headerValue="不限" cssClass="styled" style="height:25px; width: 140px;"/>
							</td>
							<td>
								<label>状态:</label><common:select name="spModel.status" valueSetId="29" headerKey="-1" headerValue="不限" cssClass="styled" style="height:25px; width: 100px;"/>
							</td>
							<td>
