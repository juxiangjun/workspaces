...
public class Fund implements java.io.Serializable {
	...
	public Fund(String code, String shortName, String fullName,
			...
			Date createdTime, Date lastUpdatedTime,Integer isSource,Integer imitateId) {
		this.code = code;
	...
	public Integer getImitateId() {
		return imitateId;
	}

	public void setImitateId(Integer imitateId) {
		this.imitateId = imitateId;
	}
