	...
	<div class="gray news_menu tab_menu2">
      ...
      <form id="comForm" class="box_form" action="/user/Profile!update.act" method="post" >
        ...
        <tr>
          ...
          <td colspan="3" class="v-align"><input type="text" value="${usrCompany.loancard }" class="input-text alnum {validate:{maxlength:30}}" name="usrCompany.loancard"/>
        ...
        <tr>
          ...
          <td class="a_left v-align"><input type="text" value="${usrCompany.faxcode }" class="input-text alnum {validate:{maxlength:15}}" name="usrCompany.faxcode"/></td>
        </tr>
        <!-- <tr>
        ...
        <tr>
          ...
          <td><input type="text" value="<s:if test="usrCompany.registeredcapital!=null"><s:text name="format.float"><s:param value="usrCompany.registeredcapital"></s:param></s:text></s:if>" class="input-text number {validate:{maxlength:12}}" name="usrCompany.registeredcapital"/>
	          &nbsp;万元<br />
	          <label for="usrCompany.registeredcapital" class="error" generated="true" style="display:none;"></label>
           </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3">
          	<textarea name="usrCompany.bizscope" class="input-text chne {maxlength:100}" style="width: 613px;height: 100px;">${usrCompany.bizscope }</textarea>
          </td>
        </tr>
        <!-- <tr>
        ...
        <tr>
		 ...
		 <tr>
          <td class="a_right">法定代表人姓名：</td>
          <td colspan="3" class="v-align"><input type="text" value="${usrCompany.legalperson }" class="input-text chcharacter {validate:{maxlength:8}}" name="usrCompany.legalperson"/></td>
        </tr>      
        <tr>
          <td class="a_right">法人学历：</td>
          <td colspan="3" class="v-align">
          <s:iterator value="dataMap['eduAtion']" id="eduAtion">
           <input type="radio" name="usrCompany.lpeducation" value="${eduAtion.id }" <s:if test="%{usrCompany.lpeducation == #eduAtion.id}"> checked</s:if>/>${eduAtion.name}
           </s:iterator>
          </td>
        </tr>
        <tr>
          <td class="a_right">法人婚姻状况：</td>
          ...
          <td class="a_right">法人从事所属行业年限：</td>
