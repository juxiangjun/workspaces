...
public class NtyMessageAction extends BaseAction {
	...
	public String viewMsg() {
		...
		// 分页显示一般信息(所有信息)
		pager = ntyMessageService.findComMsgs(pager == null ? 1 : pager.getCurrentPage(), pager == null ? 10 : pager.getPageCount(), user.getId());
	...
	public String unRead() {
		...
		topMsgs = ntyMessageService.findTopMsgs(user.getId());
		// 分页显示一般信息(未读信息)
		pager = ntyMessageService.findComMsgsNoRead(pager == null ? 1 : pager.getCurrentPage(), pager == null ? 10 : pager.getPageCount(), user.getId());
	...
	public String read() {
		...
		topMsgs = ntyMessageService.findTopMsgs(user.getId());
		// 分页显示一般信息(已读信息)
		pager = ntyMessageService.findComMsgsRead(pager == null ? 1 : pager.getCurrentPage(), pager == null ? 10 : pager.getPageCount(), user.getId());
