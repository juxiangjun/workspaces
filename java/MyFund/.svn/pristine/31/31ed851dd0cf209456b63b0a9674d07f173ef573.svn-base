...
function preview(){
	...
	$('#loanForm').submit();
	$('#loanForm').attr('action','/user/loan/financeProduct!updatefin.act');
...
<form action="/user/loan/financeProduct!updatefin.act" id="loanForm" class="box_form" style="margin:0px;" method="post">
	...
	<div class="C_form">
		<dl>
           <dd>
			...
			<dd>
                <h6>贷款产品介绍：</h6>
                <s:textarea name="product.proIntroduce" cols="80" rows="10" id="product_proIntroduce"></s:textarea>
              </dd>
		</dl>
	</div>
	<div class="clear"></div>
	...
	<div class="C_form">
		<dl>
			<dd>
              ...
              <dd >
                <div id="datalistview" style="padding-left:160px;">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:100%" >
			...
			<s:iterator value="dataFileList" id="item">
				...
				<s:if test="haveMemo == 1">
					<tr>
						<td colspan="4">
							<textarea name="otherMemo" id="otherMemo${id }" cols="90" rows="5" cssClass="{maxlength:200}">${otherMemo }</textarea>
						</td>
					</tr>
				</s:if>
			</s:iterator>
