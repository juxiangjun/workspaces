					...
					<form id="frmQueryBankProduct" action="/admin/bankProductAction.act" method="post">
						...
						<table width="100%">
							...
							<tr>
								...
								<td>
									<s:textfield id="prdBankfinance.sellstart" name="prdBankfinance.sellstart" cssClass="text date_picker"/>
								</td>
								<td>
									<s:textfield id="prdBankfinance.sellend" name="prdBankfinance.sellend" cssClass="text date_picker"/></td>
								<td>
									<s:select name="recommendationStatus" list="#{0:'未荐',1:'已荐',2:'停用'}" cssClass="cmf-skinned-select"></s:select>
								</td>
