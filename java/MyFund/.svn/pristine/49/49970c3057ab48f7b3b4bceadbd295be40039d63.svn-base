...
<script language="javascript">
    ...
    function downloadAttach(prdId){
    	var url = "/admin/loan/prdAttach!getDataTemplates.act";
...
<body>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
     		<tr class="top_color">
	            ...
	            <td style="width:160px;">已上传模版份数</td>
	            <td align="center">模版上传</td>
            </tr>
          <tbody>
		 	<s:iterator value="prdDataList">
...
<div id="fileList">
   ...
   <div class="hr_10"> &nbsp;</div>
	<s:form id="uploadForm" action="prdAttach!uploadTemplate.act" namespace="/admin/loan" method="post" enctype="multipart/form-data">
