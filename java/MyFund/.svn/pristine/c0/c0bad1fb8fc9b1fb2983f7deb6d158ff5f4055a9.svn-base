...
public class PrdFinanceDatafileDAOImpl extends HibernateDAO<PrdFinanceDatafile, Integer> implements PrdFinanceDatafileDAO {
	...
	public List<PrdFinanceDatafile> findDataFileByPrdId(Integer prdId){
		String hql = "from PrdFinanceDatafile t where t.financeId = :prdId";
		return this.list(hql,"prdId",prdId);
	}
}
