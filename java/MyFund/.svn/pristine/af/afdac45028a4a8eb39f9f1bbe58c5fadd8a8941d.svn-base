...
<table cellpadding="0" cellspacing="0" width="100%" class="tablesorter">
    ...
    <tr id="finance_interest_type">
		...
		<td>
			<table width="700" id="interest_table">
				...
				<s:if test="userGroup == 3">
				  <tr>
	                <td>服务费：</td>
	                <td><s:textfield name="product.serviceCost" cssClass="input-text number"  id="product_serviceCost" maxlength="5" size="5"></s:textfield>&nbsp;%
	...
	<tr class="even" style="color:#97181d;font-weight: bold;"><td colspan="2">产品介绍</td></tr>
		...
		<tr><td>贷款产品介绍：</td>
			<td><s:textarea name="product.proIntroduce" cols="80" rows="10" id="product_proIntroduce"></s:textarea>
              </td>
		</tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" style="width:100%" >
			...
			<s:iterator value="dataFileList" id="item">
				...
				<s:if test="haveMemo == 1">
					<tr>
						<td colspan="4">
							<textarea name="otherMemo" id="otherMemo${id }" cols="90" rows="5" cssClass="{maxlength:500}">${otherMemo }</textarea>
						</td>
					</tr>
				</s:if>
			</s:iterator>
    ...
    <tr class="even" style="color:#97181d;font-weight: bold;"><td colspan="2">申请条件</td></tr>
              ...
              <tr>
                <td>其他申请条件：</td>
                <td><s:textarea name="product.otherRequire" cols="60" rows="5" cssClass="{maxlength:500}"></s:textarea></td>
              </tr>
              <tr>
                <td>备注：</td>
                <td><s:textarea name="product.memo" cols="60" rows="5" cssClass="{maxlength:500}"></s:textarea></td>
              </tr>
