...
<script type="text/javascript">
	function showNewsHome(typeId){
		window.location.href = "/news/Info!infoGroup.act?typeId="+typeId;
	}
	function smmn() {
		if($("#smm").val()=="139"){
			$("#mm").html("年");
	...
	$(document).ready(function(){
		$('#page_index_sel').css('background','url(/images/nav_hover.png) 0% 0%');
		$('#page_index_sel a').css('color','#494949');
		smmn();
		$('#scoll').vTicker({
          speed: 500,
          pause: 3000,
...
<div class="container_960">
  <div class="grid_230">
    ...
    <div class="hr_10"> &nbsp; </div>
    <div><a href="/club/clubAction.act"><img src="/images/img_index_loan_Club.jpg" width="230" height="183"/></a></div>  
    <div class="hr_10"> &nbsp; </div> 
    <div><a href="http://www.zj198.com/news/Info.act?id=782"><img src="/images/t_work.gif" width="230" height="90"/></a></div>  
    <div class="hr_10"> &nbsp; </div>       
    <div class="menu_red white">
      <h6>最新融资动态</h6>
    </div>
    <div class="box_3" style="padding:10px 10px 10px 18px;height:158px; position:relative; overflow:hidden;">
	    <div id="scoll" >
	    <ul>
			<li><div class="rzdt_title">上海xx工贸有限公司</div>
			<div>工贸通 <span class="red">500（万元）</span> 已放款</div></li>
			<li><div class="rzdt_title">上海xx餐饮管理有限公司</div>
			<div>集品餐饮基金  <span class="red">300（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">上海xx环保科技有限公司</div>
			<div>科技信用贷 <span class="red">650 （万元）</span>审批中</div></li>
			<li><div class="rzdt_title">江苏xx机电设备有限公司</div>
			<div>工贸通 <span class="red"> 900（万元）</span> 已放款</div></li>
			<li><div class="rzdt_title">上海xx餐饮有限公司</div>
			<div>集品餐饮基金  <span class="red">500（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">上海xx工程设备有限公司</div>
			<div>工贸通 <span class="red">1200（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">上海xx餐饮有限公司</div>
			<div>集品餐饮基金  <span class="red">200（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">上海xx信息技术有限公司</div>
			<div>科技信用贷  <span class="red">600（万元）</span>审批中</div></li>
			<li><div class="rzdt_title">上海xx五金设备有限公司</div>
			<div>足额抵押贷  <span class="red">210（万元）</span> 已放款</div></li>
			<li><div class="rzdt_title">上海xx餐饮有限公司</div>
			<div>集品餐饮基金  <span class="red">100（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">苏州xx机械设备有限公司</div>
			<div>融资租赁  <span class="red">1000（万元）</span> 已放款</div></li>
			<li><div class="rzdt_title">上海xx纺织品有限公司</div>
			<div>非足额抵押贷款  <span class="red">680（万元）</span> 审批中</div></li>
			<li><div class="rzdt_title">上海xx软件技术有限公司</div>
			<div>科技信用贷  <span class="red">600 （万元）</span>审批中</div></li>
			<li><div class="rzdt_title">上海xx海产品有限公司</div>
			<div>速贷通  <span class="red"> 150（万元）</span> 已放款</div></li>
			<li><div class="rzdt_title">上海xx实业发展有限公司</div>
			<div>企保通  <span class="red">500（万元）</span> 审批中</div></li>
	    </ul>
	    </div>
	</div>    
    <div class="hr_10"> &nbsp; </div>   
  ...
  <div class="grid_710">
    ...
    <div class="hr_10"> &nbsp; </div>     
    <div class="box_4" style="padding:5px 20px;">截至11月份，中国资金网注册会员<span class="red">253995</span>家，已成功为<span  class="red">2397</span>家企业提供融资服务，累计融资额<span class="red">18</span>亿元。</div>
    <div class="hr_10"> &nbsp; </div>        
        ...
        <div class="qyrz-bot">
          <div class="qyrz-bot-l fl">
            <h6 class="remen">集品餐饮基金</h6>
            	集品企联，只为优质餐饮企业量身定制的金融服务！创造餐饮行业的抱团价值，问题当然迎刃而解！<br/>
            <a class="lchot" href="/finance/financeProduct!cateringf.act">了解详情</a>
          </div>
          <a href="/finance/financeProduct!cateringf.act"><img class="fr" src="/images/sp.jpg" style="margin-top:10px;"/></a>
         </div>
        <div class="hr_10"> &nbsp; </div>      
      </div>
    </div>
...
<div class="links container_960">
  ...
  <div class="box_3"> 
    ...
    <ul class="bank_logo">
      ...
      <li><a href="http://www.chinaccm.com/" target="_blank"/><img src="/images/linkimg/chinaccm1.png" /></a></li>
