				...
				<div>
					<table class="special_psfs_tb">
						<tr>
							...
							<td class="a_left">${profileMap['companyType'] }</td>
						</tr>
						<tr>
...
<div id="pro_recommend" style="display:none;" title="推荐融资产品">
	<span style="padding-left:30px;">产品名称：<input type="text" name="prdName" id="r_prdName"/></span>&nbsp;
	<input type="button" onclick="RecommendFind(${loan.id})" value="查询" class="but_gray"/>
	<div class="hr_10"> &nbsp;</div>
