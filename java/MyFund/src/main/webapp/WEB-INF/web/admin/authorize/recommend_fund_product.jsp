		...
		<div class="wrapper">
			...
			<div class="block">
				...
				<div style="padding-left:20px; padding-top:20px">
					<form id="frmPrdRecommendation" action="/admin/fund/fund!savePrdRecommendation.act" method="post">
						...
						<p>
							<label>基金公司:</label><br />
							<s:select list="fundCompanyList" listKey="id" listValue="fullName"
						...
						<p>
							<label>推荐明细:</label><br /><textarea   id="prdRecommendation.memo" name="prdRecommendation.memo" class="required xheditor small">${prdRecommendation.memo }</textarea> 
						</p>
