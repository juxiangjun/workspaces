	...
	<div class="wrapper">
		...
		<div id="umsg" class="message success" style="display: none;"></div>
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="tablesorter">
				...
				<s:if test="fund!=null">
					<tr><td>代码</td><td><input name="fund.code" value="${fund.code }" class="text" readonly="readonly"/></td></tr>
					...
					<tr><td>基金类型</td><td> <input name="fund.catelogName" value="${fund.catelogName }" class="text"/></td></tr>
					...
					<tr><td>风险收益特征</td><td><textarea name="fund.characteristics" class="required xheditor">${fund.characteristics}</textarea></td></tr>
					...
					<tr><td>基金公司名称</td><td> 
						<input id="fundCompanyId" type="hidden" name="fund.fundCompanyId" value="${fund.fundCompanyId }"/> 
						...
						<s:select id="companyList" list="fundCompanyList" listKey="id" listValue="fullName"
								 cssClass="cmf-skinned-select" headerKey="fund.fundCompanyId" 
					...
					<tr><td>创建时间</td><td><input name="fund.createdTime" value="<s:date name="fund.createdTime"/>" class="text date_picker" readonly="readonly"/></td></tr>
					<tr><td>更新时间</td><td><input name="fund.lastUpdatedTime" value="<s:date name="fund.lastUpdatedTime"/>" class="text date_picker" readonly="readonly"/></td></tr>
