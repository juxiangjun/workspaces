...
<script type="text/javascript">
	function watchIt(id){
		$('#img_app').html("<img src='/admin/loan/downloadAttach.act?type=0&falistId="+id+"'/>");
		$('#img_app').dialog({
			width : 700,
    		modal:true
		});
...
<s:if test="attach.uploadWay == null || attach.uploadWay == 0">
	<s:iterator value="faList">
		<li>
			${oldFileName }(<s:date name="createdt" format="yyyy-MM-dd HH:mm"/>) &nbsp;&nbsp;<a href="/admin/loan/downloadAttach.act?type=0&falistId=${id }">下载</a>
