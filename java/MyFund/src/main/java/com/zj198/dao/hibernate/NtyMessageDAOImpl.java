...
public class NtyMessageDAOImpl extends HibernateDAO<NtyMessage, Long> implements NtyMessageDAO {
	...
	public Pager findComMsgs(Integer pageNo, Integer pageSize, Integer uid) {
		...
		String hql = "select new NtyMessage(o.id,o.title,o.contents,u.isRead) from NtyMessage o, NtyReceiver u " +
				"where o.type = 2 and o.isSenderDeleted = 0 and " +
				"u.isReceiverDeleted = 0 and u.messageid = o.id and " +
				"u.receiver = :receiver order by o.id desc";
		j.put("receiver", uid);
	...
	public Pager findComMsgsNoRead(Integer pageNo, Integer pageSize, Integer uid) {
		Hashtable<String, Object> j = new Hashtable<String, Object>();
		String hql = "select new NtyMessage(o.id,o.title,o.contents,u.isRead) from NtyMessage o, NtyReceiver u  where o.type = 2 and o.isSenderDeleted = 0 and u.isRead = 0 and u.isReceiverDeleted = 0 and u.messageid = o.id and u.receiver = :receiver order by o.id desc";
		j.put("receiver", uid);
		return pagedQuery(hql, pageNo, pageSize, j);
	}
