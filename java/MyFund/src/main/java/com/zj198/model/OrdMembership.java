...
public class OrdMembership implements java.io.Serializable {
	...
	private Integer invoiceSendway;
	...
	public OrdMembership(Integer id, Integer userId, Double payAmount,
			...
			Integer iscancelled, String username,String ordNum) {
		this.id = id;
		this.userId = userId;
	...
	public Integer getInvoiceSendway() {
		return this.invoiceSendway;
	}

	public void setInvoiceSendway(Integer invoiceSendway) {
		this.invoiceSendway = invoiceSendway;
	}
