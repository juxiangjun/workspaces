...
from utils.app_util import get_now, get_value, format_null_date
...
class FundDividend(Base):
	...
	def __init__(self, fund, html_data):
		...
		self.register_date = format_null_date(get_value(html_data[1]))
		self.ex_dividend_date = format_null_date(get_value(html_data[2]))
		self.delivered_date = format_null_date(get_value(html_data[3]))
